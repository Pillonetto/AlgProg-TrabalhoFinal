...
/* Funcao retorna a posicao onde um Score deve ser colocado no ranking,
    garantindo que ficara ordenado. Se pontuacao nao foi suficiente para o ranking, retorna -1

    @param vetor de ranking
    @param pontuacao a ser checada  */
...
/* Funcao atualiza o array de Scores e salva o arquivo ranks.

    @param vetor de ranking
    @param Score a ser inserido no ranking
    @param numero da posicao a inserir  */
...
/*  Funcao salva em ranks.txt os nomes e pontuacoes do ranking
...
/*  Funcao carrega os nomes e pontuacoes para um array de Scores na main

    @param vetor que recebera o ranking */
